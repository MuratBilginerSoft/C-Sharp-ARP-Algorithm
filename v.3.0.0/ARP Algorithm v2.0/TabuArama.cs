    ...
    public partial class TabuArama : Form
    {
        ...
        private void AlgoritmaBaşlat_Click(object sender, EventArgs e)
        {
            ...
            if (ComboDurdurma.Text == "En İyi Çözüm")
            {
                ...
                EnİyiMesafe = Convert.ToInt32(NumericEnİyi.Value);
            }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            {
                ÇizimYap.DrawLine(Kalem, Convert.ToInt32(TabloT.Rows[EnİyiRotaSeçim[i6]]["X"]), Convert.ToInt32(TabloT.Rows[EnİyiRotaSeçim[i6]]["Y"]), Convert.ToInt32(TabloT.Rows[EnİyiRotaSeçim[i6 + 1]]["X"]), Convert.ToInt32(TabloT.Rows[EnİyiRotaSeçim[i6 + 1]]["Y"]));
            }
        }
